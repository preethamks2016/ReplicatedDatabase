...
public class LevelDBNormalClient implements Watcher {
    ...
    public LevelDBNormalClient(String zooKeeperAddress, String leaderPath, String servicePath,  ConsistencyType consistencyType) throws Exception {
...
//        populateReadServers();
    ...
    public static void main(String[] args) {
        ...
        val.add("arr-000");
        val.add( "arr-001");
        TreeSet<String> set = new TreeSet<>(val);
        System.out.println(set.lower("arr-001"));
